...
export default function HireReceipt() {
  ...
  return (
    <div className="p-12 max-w-4xl mx-auto bg-white rounded-2xl shadow-2xl border border-gray-200 space-y-10">
      {/* Header */}
      <div className="flex justify-between items-start">
        <div className="space-y-2">
          <h1 className="text-4xl font-extrabold text-gray-800">Car Hire Receipt</h1>
